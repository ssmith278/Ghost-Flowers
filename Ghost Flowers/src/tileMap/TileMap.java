...
public class TileMap implements Serializable{
	 ...
	 * Serial ID
	 */
	private static final long serialVersionUID = -6458760354710130298L;
	...
	public void loadTiles(String s) {
		...
		try {
			...
			tiles = new Tile[2][numTilesAcross]; //change based off of tileset
			...
			for(int col = 0; col < numTilesAcross; col++) {
				...
				tiles[1][col] = new Tile(subimage, Tile.BLOCKED); //second row tiles are blocked
			}
